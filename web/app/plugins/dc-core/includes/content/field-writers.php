 ...
 * per component type. Matches dc_make_components_field() — the full
...
function build_component_row(string $type, array $row, array $media_table): ?array
{
    ...
    switch ($type) {
        case 'richtext':
            return ['_type' => 'richtext', 'html' => (string) ($row['html'] ?? $row['dc_richtext_body'] ?? '')];
        ...
        case 'cta':
            return [
                ...
                'button_label' => (string) ($row['button_label'] ?? $row['dc_cta_label'] ?? ''),
                'button_url'   => (string) ($row['button_url'] ?? $row['dc_cta_url'] ?? ''),
            ];
        ...
        case 'stats':
            ...
            return [
                ...
                'figures'          => dc_stats_to_lines($row['stats'] ?? []),
            ];
