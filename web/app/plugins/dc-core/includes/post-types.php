 ...
 *
 * Ships ONE generic example CPT — `dc_resource` — to demonstrate the
...
function register_resource(): void
{
    ...
    if (isset($post_types['dc_resource'])) {
        register_post_type('dc_resource', $post_types['dc_resource']);
    }
}
