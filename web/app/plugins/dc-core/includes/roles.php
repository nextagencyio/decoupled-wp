 ...
 *                     `dc_resource` CPT, default pages, and the
...
function register_all(): void
{
    ...
    if (!get_role('content_editor')) {
        add_role('content_editor', __('Content Editor', 'dc-core'), $caps);
    } else {
 ...
 *
 * @param string $singular  e.g. 'dc_resource'
 * @param string $plural    e.g. 'dc_resources'
 * @return array<string, bool>
 */
