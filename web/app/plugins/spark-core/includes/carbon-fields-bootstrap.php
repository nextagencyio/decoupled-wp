 ...
 * web/app/plugins/spark-core/vendor/carbon-fields/build/ so they are
...
namespace Spark\Core\CarbonFields;
...
if (!defined('Carbon_Fields\\URL')) {
    define(
        'Carbon_Fields\\URL',
        plugins_url('vendor/carbon-fields', dirname(__DIR__) . '/spark-core.php')
    );
}
