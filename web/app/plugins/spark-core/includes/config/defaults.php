    ...
    return [
        ...
        'postTypes' => [
            ...
            'spark_resource' => [
                ...
                'capability_type'     => ['spark_resource', 'spark_resources'],
                'map_meta_cap'        => true,
            ],
        ],
        'taxonomies' => [
            'spark_topic' => [
                'object_type' => ['spark_resource', 'post'],
                'args' => [
                    'labels' => [
                        'name'          => 'Topics',
                        'singular_name' => 'Topic',
        ...
        'graphql' => [
            ...
            'fields' => [
                'heroImage' => [
                    ...
                    'resolver'    => 'heroImage',
                    'srcKey'      => 'spark_hero_image',
                    'altKey'      => 'spark_hero_alt',
                ],
                'introParagraphs' => [
                    'type'        => ['list_of' => 'String'],
