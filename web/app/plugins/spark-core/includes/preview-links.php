 ...
 * a `page` lives at `/<slug>/` and a `spark_resource` at
 ...
 *
 * Config:
 *   - SPARK_FRONTEND_URL          frontend origin (define or env var)
 *   - WORDPRESS_PREVIEW_SECRET    shared secret the Astro /api/preview
 *                                 route verifies
 */

namespace Spark\Core\PreviewLinks;
...
function preview_secret(): string
{
    ...
    return getenv('WORDPRESS_PREVIEW_SECRET') ?: 'spark_preview_dev_secret';
}
